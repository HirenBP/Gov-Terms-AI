...
const AboutPanel = () => (
  <div>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '16px' }}>
      <svg height="24" aria-hidden="true" viewBox="0 0 24 24" version="1.1" width="24" data-view-component="true" className="octicon octicon-mark-github" style={{ fill: 'currentColor' }}>  
